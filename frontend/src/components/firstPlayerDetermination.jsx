              ...
              <div className="mb-8">
                ...
                <div className="flex gap-6 justify-center mb-8">
                  <button
                    ...
                    className={`px-12 py-6 rounded-xl font-bold text-2xl transition-all duration-200 ${userNumber === '0'
                  ...
                  <button
                    ...
                    className={`px-12 py-6 rounded-xl font-bold text-2xl transition-all duration-200 ${userNumber === '1'
                        ? 'bg-green-500 text-white shadow-lg transform scale-105'
                        : 'bg-gray-200 text-gray-700 hover:bg-gray-300 hover:shadow-md'
                      }`}
                  >
          ...
          {stage === 'result' && result && (
            <div className="text-center">
              <div className="mb-8">
                ...
                <div className="bg-blue-100 border-2 border-blue-400 rounded-xl p-8 shadow-lg">
                  <h4 className="font-bold text-blue-900 mb-6 text-lg">Numbers Revealed</h4>
                  <div className="space-y-4">
                    <div className="flex justify-between text-xl">
                      <span className="text-gray-700">Your number:</span>
                      <span className="font-bold text-green-700">{result.userNumber}</span>
                    </div>
                    <div className="flex justify-between text-xl">
                      <span className="text-gray-700">Computer's number:</span>
                      <span className="font-bold text-blue-700">{result.computerNumber}</span>
                    </div>
                    ...
                    <div className="flex justify-between text-lg">
                      <span className="text-gray-700">Result (mod 2):</span>
                      <span className="font-bold text-purple-700">{result.result}</span>
                    </div>
                  </div>
                ...
                <div className={`text-3xl font-bold mb-6 ${result.firstPlayer === 'player' ? 'text-green-600' : 'text-blue-600'
                  }`}>
